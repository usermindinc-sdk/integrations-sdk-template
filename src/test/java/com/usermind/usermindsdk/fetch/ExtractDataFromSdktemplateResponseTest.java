...
class ExtractDataFromSdktemplateResponseTest extends TestBase {
    ...
    void testBasic() throws Exception {
        ...
        ExtractedData results = extractor.extractData(TestClassFactory.getCredentialContainerSdktemplate(), "entity", entityString, "");
        ...
        assertThat(results.getExtractedDataItems().size() > 0).isTrue();
