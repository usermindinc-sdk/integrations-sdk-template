...
@Component
public class ExtractDataFromSdktemplateResponse implements ExtractDataFromResponse<SdktemplateConnectionData> {
    ...
    public ExtractedData extractData(SdktemplateConnectionData sdktemplateConnectionData, String entityName,
        ...
        */
        ...
        //TODO: And if you got invalid records - record them, which is needed for tracking later when you're asked what happened
